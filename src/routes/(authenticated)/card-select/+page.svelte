...
<main>
	<div class="headerContainer">
		...
		<div class="header_center">
			<div class="imgHolder">
				<img src="{selected_faction.name}.png" alt="{selected_faction.name} logo" />
				<h1>{selected_faction.name}</h1>
			</div>
	...
	<div class="selectorholder">
		...
		<section class="info">
			...
			<button class="leader" on:click={() => switchLeader()}>
				<img
					src="{shownLeaders[count].name}.webp"
					alt={shownLeaders[count].name}
			...
			<div style="display:inline-flex; align-items: center;">
				<img
					src="cards_symbol.png"
					alt="Total Cards"
					style="width: 4vh; height: 4vh; margin-right: 1.4vw;"
				/>
			...
			<div style="display:inline-flex; align-items: center;">
				<img
					src="Unit Cards.png"
					alt="Unit Card"
					style="width: 5vh; height: 5vh; margin-right: 1vw;"
				/>
			...
			<div style="display:inline-flex; align-items: center;">
				<img
					src="Special Cards.png"
					alt="Special Card"
					style="width: 5vh; height: 5vh; margin-right: 1vw;"
				/>
				<p style="color:limegreen">
					{selected_deck.filter((card) => card.type == 'special').length} / 10
				</p>
			</div>
			...
			<div style="display:inline-flex; align-items: center;">
				<img
					src="Total Strength.png"
					alt="Unit Strength"
					style="width: 5vh; height: 5vh; margin-right: 1vw;"
				/>
				<p>
					{selected_deck
						.filter((card) => card.type == 'unit' || card.type == 'hero')
	...
	<button class="confirm" disabled={findingMatch} on:click|preventDefault={() => confirm()}>
		<img src="keyboard_enter_outline.png" alt="enter" class="enter" />
		{start}
	</button>

	<button class="confirm find-match" on:click|preventDefault={goToFindMatch}> Find Match </button>
</main>
