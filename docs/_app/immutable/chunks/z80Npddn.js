import { s as f, n as l } from './BkTvAqf4.js';
import {
	S as u,
	i as b,
	d as r,
...
function w(p) {
	let e,
		...
		n,
		a,
		d = `After another months development a good amount of progress has been made.
...
are correctly placed.`;
	return {
		c() {
			(e = m('h1')), (e.textContent = i), (n = g()), (a = m('p')), (a.textContent = d);
		},
		l(t) {
			(e = c(t, 'H1', { 'data-svelte-h': !0 })),
				h(e) !== 'svelte-kj9duf' && (e.textContent = i),
				(n = v(t)),
				(a = c(t, 'P', { 'data-svelte-h': !0 })),
				h(a) !== 'svelte-ql76ya' && (a.textContent = d);
		},
		m(t, o) {
			s(t, e, o), s(t, n, o), s(t, a, o);
		},
		p: l,
		i: l,
		o: l,
...
const x = { title: 'Devblog 2', date: '2025-05-07' },
	{ title: C, date: k } = x;
class H extends u {
	constructor(e) {
		super(), b(this, e, null, w, f, {});
	}
}
export { H as default, x as metadata };
